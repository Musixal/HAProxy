...
while true; do	
	clear
    read -p "1. Enter HAProxy bind port: " haproxy_bind_port
    read -p "2. Enter Destination (Kharej) IP address: " destination_ip
    read -p "3. Enter Destination port: " destination_port
...
display_menu(){
    ...
    echo "-------------------------------"
    echo "Menu:"
    echo -e "${GREEN}1. Configure tunneling to multiple-servers${NC}"
    echo -e "${BLUE}2. Configure Loadbalancing${NC}"
